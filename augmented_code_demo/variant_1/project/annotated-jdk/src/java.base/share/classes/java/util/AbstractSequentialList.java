...
public abstract class AbstractSequentialList<E> extends AbstractList<E> {
    ...
    @PolyNonEmpty
    @Positive
    public Iterator<E> iterator(@PolyGrowShrink @PolyNonEmpty AbstractSequentialList<E> this);

    @Positive
    @PolyGrowShrink
    @Positive
    public abstract ListIterator<E> listIterator(@PolyGrowShrink AbstractSequentialList<E> this, int index);
    @Positive
}
