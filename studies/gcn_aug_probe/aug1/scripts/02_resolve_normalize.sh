...
base = Path("/home/ubuntu/GenDATA/studies/gcn_aug_probe/aug1")
src = resolve_slice_dir(base)
if not src or count_java(src)==0:
  from pipeline import run_slicing
  run_slicing("/home/ubuntu/checker-framework/checker/tests/index", "/home/ubuntu/GenDATA/index1.out", "/home/ubuntu/GenDATA", "/home/ubuntu/GenDATA/studies/gcn_aug_probe/aug1/slices", "cf")
  src = resolve_slice_dir(base)
if not src or count_java(src)==0:
  raise SystemExit("ERROR: No slices (.java) found after CF fallback")
dst = Path("/home/ubuntu/GenDATA/studies/gcn_aug_probe/aug1/normalized_slices")
