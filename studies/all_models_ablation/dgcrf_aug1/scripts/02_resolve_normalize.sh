...
base = Path("/home/ubuntu/GenDATA/studies/all_models_ablation/dgcrf_aug1")
src = resolve_slice_dir(base)
if not src or count_java(src)==0:
  from pipeline import run_slicing
  run_slicing("/home/ubuntu/checker-framework/checker/tests/index", "/home/ubuntu/GenDATA/index1.out", "/home/ubuntu/GenDATA", "/home/ubuntu/GenDATA/studies/all_models_ablation/dgcrf_aug1/slices", "cf")
  src = resolve_slice_dir(base)
if not src or count_java(src)==0:
...
dst = Path("/home/ubuntu/GenDATA/studies/all_models_ablation/dgcrf_aug1/normalized_slices")
