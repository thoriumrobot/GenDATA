...
public class Polymorphic3 {
  ...
  void lbc_id(@NonNegative int n, @Positive int p, @GTENegativeOne int g) {
    @Positive
    @NonNegative int identity(n) = identity(n);
    // :: error: (assignment)
    @Positive
    @Positive int bn = identity(n);
...
public class Polymorphic3 {
  ...
  void lbc_id(@NonNegative int n, @Positive int p, @GTENegativeOne int g) {
    ...
    // :: error: (assignment)
    @Positive
    @Positive int identity(n) = identity(n);
...
public class Polymorphic3 {
  ...
  void lbc_id(@NonNegative int n, @Positive int p, @GTENegativeOne int g) {
    ...
    @Positive
    @GTENegativeOne int identity(g) = identity(g);
    // :: error: (assignment)
    @Positive
    @NonNegative int bg = identity(g);
...
public class Polymorphic3 {
  ...
  void lbc_id(@NonNegative int n, @Positive int p, @GTENegativeOne int g) {
    ...
    // :: error: (assignment)
    @Positive
    @NonNegative int identity(g) = identity(g);
...
public class Polymorphic3 {
  ...
  void lbc_id(@NonNegative int n, @Positive int p, @GTENegativeOne int g) {
    ...
    @Positive
    @Positive int identity(p) = identity(p);
    @Positive
  }
    @Positive
}
