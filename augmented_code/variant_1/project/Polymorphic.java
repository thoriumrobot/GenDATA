...
public class Polymorphic {
  ...
  void ubc_id(
    ...
    @Positive
    @LTLengthOf("a") int ubc_identity(ai) = ubc_identity(ai);
    // :: error: (assignment)
    @Positive
...
public class Polymorphic {
  ...
  void ubc_id(
    ...
    // :: error: (assignment)
    @Positive
    @LTLengthOf("b") int ubc_identity(ai) = ubc_identity(ai);
...
public class Polymorphic {
  ...
  void ubc_id(
    ...
    @Positive
    @LTEqLengthOf("a") int ubc_identity(al) = ubc_identity(al);
    // :: error: (assignment)
    @Positive
    @LTLengthOf("a") int al2 = ubc_identity(al);
...
public class Polymorphic {
  ...
  void ubc_id(
    ...
    // :: error: (assignment)
    @Positive
    @LTLengthOf("a") int ubc_identity(al) = ubc_identity(al);
...
public class Polymorphic {
  ...
  void ubc_id(
    ...
    @Positive
    @LTLengthOf({"a", "b"}) int ubc_identity(abi) = ubc_identity(abi);
    // :: error: (assignment)
    @Positive
    @LTLengthOf({"a", "b", "c"}) int abi2 = ubc_identity(abi);
...
public class Polymorphic {
  ...
  void ubc_id(
    ...
    // :: error: (assignment)
    @Positive
    @LTLengthOf({"a", "b", "c"}) int ubc_identity(abi) = ubc_identity(abi);
...
public class Polymorphic {
  ...
  void ubc_id(
    ...
    @Positive
    @LTEqLengthOf({"a", "b"}) int ubc_identity(abl) = ubc_identity(abl);
    // :: error: (assignment)
    @Positive
    @LTEqLengthOf({"a", "b", "c"}) int abl2 = ubc_identity(abl);
    @Positive
...
public class Polymorphic {
  ...
  void ubc_id(
    ...
    // :: error: (assignment)
    @Positive
    @LTEqLengthOf({"a", "b", "c"}) int ubc_identity(abl) = ubc_identity(abl);
    @Positive
  }
...
public class Polymorphic {
  ...
  void lbc_id(@NonNegative int n, @Positive int p, @GTENegativeOne int g) {
    @Positive
    @NonNegative int lbc_identity(n) = lbc_identity(n);
    // :: error: (assignment)
    @Positive
    @Positive int bn = lbc_identity(n);
...
public class Polymorphic {
  ...
  void lbc_id(@NonNegative int n, @Positive int p, @GTENegativeOne int g) {
    ...
    // :: error: (assignment)
    @Positive
    @Positive int lbc_identity(n) = lbc_identity(n);
...
public class Polymorphic {
  ...
  void lbc_id(@NonNegative int n, @Positive int p, @GTENegativeOne int g) {
    ...
    @Positive
    @GTENegativeOne int lbc_identity(g) = lbc_identity(g);
    // :: error: (assignment)
    @Positive
    @NonNegative int bg = lbc_identity(g);
...
public class Polymorphic {
  ...
  void lbc_id(@NonNegative int n, @Positive int p, @GTENegativeOne int g) {
    ...
    // :: error: (assignment)
    @Positive
    @NonNegative int lbc_identity(g) = lbc_identity(g);
...
public class Polymorphic {
  ...
  void lbc_id(@NonNegative int n, @Positive int p, @GTENegativeOne int g) {
    ...
    @Positive
    @Positive int lbc_identity(p) = lbc_identity(p);
    @Positive
  }
    @Positive
}
