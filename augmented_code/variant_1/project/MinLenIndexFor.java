...
public class MinLenIndexFor {
  ...
  void test2(@IndexOrHigh("this.arrayLen4") int i) {
    ...
    if (i > 0) {
    @Positive
      int arrayLen4[i - 1] = arrayLen4[i - 1];
    @Positive
    }
    @Positive
    int j2 = arrayLen4[1];
