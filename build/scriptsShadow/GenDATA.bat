...
set CLASSPATH=%APP_HOME%\lib\GenDATA-all.jar

@rem Execute GenDATA
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %GEN_DATA_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%GEN_DATA_EXIT_CONSOLE%" exit 1
exit /b 1
